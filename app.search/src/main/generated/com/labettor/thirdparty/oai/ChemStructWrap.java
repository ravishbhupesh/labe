 ...
 *       &lt;group ref="{https://jats.nlm.nih.gov/ns/archiving/1.0/}chem-struct-wrap-model"/&gt;
...
@XmlType(name = "", propOrder = {
    ...
    "alternativesOrChemStructOrCode",
    "attribOrPermissions"
})
...
public class ChemStructWrap {
    ...
    protected List<Object> alternativesOrChemStructOrCode;
    @XmlElements({
    ...
    /**
     * Gets the value of the alternativesOrChemStructOrCode property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the alternativesOrChemStructOrCode property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAlternativesOrChemStructOrCode().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getAlternativesOrChemStructOrCode() {
        if (alternativesOrChemStructOrCode == null) {
            alternativesOrChemStructOrCode = new ArrayList<Object>();
        }
        return this.alternativesOrChemStructOrCode;
    }
