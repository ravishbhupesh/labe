 ...
 *         &lt;group ref="{https://jats.nlm.nih.gov/ns/archiving/1.0/}collab-elements"/&gt;
 *       &lt;/choice&gt;
...
public class Collab {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "addr-line", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = AddrLine.class),
        @XmlElementRef(name = "postal-code", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = PostalCode.class),
        @XmlElementRef(name = "contrib-group", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = ContribGroup.class),
        ...
        @XmlElementRef(name = "author-comment", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = AuthorComment.class),
        ...
        @XmlElementRef(name = "aff", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = Aff.class),
        @XmlElementRef(name = "named-content", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = NamedContent.class),
        @XmlElementRef(name = "country", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = Country.class),
        ...
        @XmlElementRef(name = "fax", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = Fax.class),
        ...
        @XmlElementRef(name = "city", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = City.class),
        ...
        @XmlElementRef(name = "aff-alternatives", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = AffAlternatives.class),
        @XmlElementRef(name = "bio", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = Bio.class),
        @XmlElementRef(name = "abbrev", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = Abbrev.class),
        @XmlElementRef(name = "phone", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = Phone.class),
        ...
        @XmlElementRef(name = "state", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = State.class),
        @XmlElementRef(name = "xref", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = Xref.class),
        @XmlElementRef(name = "on-behalf-of", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = OnBehalfOf.class),
