 ...
 *         &lt;group ref="{https://jats.nlm.nih.gov/ns/archiving/1.0/}string-conf-elements"/&gt;
 *       &lt;/choice&gt;
...
public class StringConf {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "string-conf", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = StringConf.class),
        ...
        @XmlElementRef(name = "conf-theme", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = ConfTheme.class),
        @XmlElementRef(name = "conf-num", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = ConfNum.class),
