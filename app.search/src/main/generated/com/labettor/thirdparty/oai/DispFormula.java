 ...
 *       &lt;group ref="{https://jats.nlm.nih.gov/ns/archiving/1.0/}disp-formula-model" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class DispFormula {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "kwd-group", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = KwdGroup.class),
        ...
        @XmlElementRef(name = "alt-text", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = AltText.class),
        @XmlElementRef(name = "sc", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = Sc.class),
        @XmlElementRef(name = "permissions", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = Permissions.class),
        ...
        @XmlElementRef(name = "attrib", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = Attrib.class),
        ...
        @XmlElementRef(name = "long-desc", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = LongDesc.class),
        ...
        @XmlElementRef(name = "abstract", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = Abstract.class),
