 ...
 *       &lt;group ref="{https://jats.nlm.nih.gov/ns/archiving/1.0/}tbody.content" maxOccurs="unbounded"/&gt;
...
public class Tbody {
    ...
    @XmlElement(name = "tr")
    protected List<Tr> tbodyContent;
    ...
    /**
     * Gets the value of the tbodyContent property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the tbodyContent property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTbodyContent().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Tr> getTbodyContent() {
        if (tbodyContent == null) {
            tbodyContent = new ArrayList<Tr>();
        }
