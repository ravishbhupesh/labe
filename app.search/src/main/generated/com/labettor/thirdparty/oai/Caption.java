 ...
 *       &lt;group ref="{https://jats.nlm.nih.gov/ns/archiving/1.0/}caption-model"/&gt;
...
public class Caption {
    ...
    @XmlElement(name = "p")
    protected List<P> captionBodyParts;
    ...
    /**
     * Gets the value of the captionBodyParts property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the captionBodyParts property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCaptionBodyParts().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<P> getCaptionBodyParts() {
        if (captionBodyParts == null) {
            captionBodyParts = new ArrayList<P>();
        }
        return this.captionBodyParts;
    }
