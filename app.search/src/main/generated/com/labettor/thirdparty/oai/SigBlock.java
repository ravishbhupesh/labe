 ...
 *         &lt;group ref="{https://jats.nlm.nih.gov/ns/archiving/1.0/}sig-block-elements"/&gt;
 *       &lt;/choice&gt;
...
public class SigBlock {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "contrib", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = Contrib.class),
        ...
        @XmlElementRef(name = "sig", namespace = "https://jats.nlm.nih.gov/ns/archiving/1.0/", type = Sig.class),
